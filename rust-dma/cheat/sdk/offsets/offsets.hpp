...
{
	// Global
	inline std::uintptr_t main_camera = 233852960;
	inline std::uintptr_t base_net_workable = 233592800;
	...
	// BaseCombatEntity
	inline std::uintptr_t player_model = 0x3E0;
	inline std::uintptr_t player_name = 0x2A8;
