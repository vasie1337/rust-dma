...
{
	// Global
	inline std::uintptr_t main_camera = 0xBB9E198;
	inline std::uintptr_t base_net_workable = 0xBC09798;
	...
	// BaseCombatEntity
	inline std::uintptr_t player_model = 0x578;
	inline std::uintptr_t player_name = 0x630;
